...
-(BOOL)isGreaterToDate:(NSString *)pStrToDate{
	...
	NSDate *dateFrom = [Helper getDateFromString:self withFormat:@"yyyy-MM-dd hh:mm a"];
	NSDate *dateTo = [Helper getDateFromString:pStrToDate withFormat:@"yyyy-MM-dd hh:mm a"];
